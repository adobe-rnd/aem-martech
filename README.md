...
The AEM MarTech plugin is essentially a wrapper around the Adobe Experience Platform WebSDK (v2.27.0) and the Adobe Client Data Layer (v2.0.2), and that can seamlessly integrate your website with:
...
- 🔬 speculative prerender aware: the library the library supports [speculative prerendering](https://developer.mozilla.org/en-US/docs/Web/API/Speculation_Rules_API) and won't fire Analytics events (and artificially inflate your page views) until the page is actually viewed
