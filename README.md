...
# AEM Edge Delivery Services Marketing Technology (Improved)
...
- [AEM Edge Delivery Services Marketing Technology (Improved)](#aem-edge-delivery-services-marketing-technology-improved)
...
- **Adobe Experience Platform WebSDK**: `v2.27.0` (`alloy.min.js`)
